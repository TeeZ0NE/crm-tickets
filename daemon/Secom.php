...
//$url = config('curl-connection.secom.url');
//$identifier = config('curl-connection.secom.identifier');
//$secret = config('curl-connection.secom.secret');
//
////GetTickets
//$tiketsfields = array(
//    'username' => $identifier,
...
//);
//
//$tikets = json_decode(getWhmcsData($tiketsfields, $url), true);
//
//$arr = [];
//
////GetTicket
...
//    foreach ($item as $val) {
//        $tiketfields['ticketid'] = $val['id'];
//        $arr[$val['id']] = json_decode(getWhmcsData($tiketfields, $url), true);
//    }
//}
//
