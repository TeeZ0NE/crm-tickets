...
$data1 = json_decode(file_get_contents('https://secom.com.ua/tickets/coopertino.json'), true);
$data2 = json_decode(file_get_contents('https://secom.com.ua/tickets/uahosting_company.json'), true);
$data3 = json_decode(file_get_contents('https://secom.com.ua/tickets/adminvps.json'), true);
$data4 = json_decode(file_get_contents('https://secom.com.ua/tickets/skt.json'), true);
$data5 = json_decode(file_get_contents('https://secom.com.ua/tickets/hostiman.json'), true);
$data6 = json_decode(file_get_contents('https://secom.com.ua/tickets/secom.json'), true);
