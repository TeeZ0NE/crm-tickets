...
error_reporting(0);
$url = "https://my.adminvps.ru/includes/api.php"; # URL sto WHMCS API file
$username = "secom_vm"; # Admin username goes here
$password = "asw4rtyh45"; # Admin password goes here
...
$newtickets[$ticketid]["datelast"]=$params2['lastreply'];
$newtickets[$ticketid]["department"]="AdminVPS";
