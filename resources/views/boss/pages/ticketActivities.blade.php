	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 mb-md-2 mb-lg-3">
				<div class="card">
					<h5 class="card-header">{{$service}} <a href="{{$href_link}}{{$ticketid}}">{{$ticketid}}</a> {{$subject}}</h5>
					<div class="card-body">
						<table class="table table-striped">
							...
							@forelse($activities as $activity)
								<tr>
									<td>{{$activity->user_name}} <small>({{$activity->admin_nik}})</small></td>
								...
								@empty <tr><td colspan="4">Nothing</td></tr>
							@endforelse
							</tbody>
						</table>
					</div>
