...
<form action="{{route('admins.store')}}" method="POST">{{csrf_field()}}
	...
	<div class="col-lg-6 mx-auto">
		<div class="input-group mb-3">
			...
			<input type="text" class="form-control" placeholder="Имя администратора" aria-label="name" aria-describedby="name-addon" name="name" value="{{old('name')}}">
		</div>
		<div class="input-group mb-3">
			<div class="input-group-prepend">
		...
		<div class="input-group mb-3">
			<input type="text" class="form-control pass-gen" placeholder="Сгенерировать пароль" aria-label="Recipient's username" aria-describedby="pass-gen" readonly>
			<div class="input-group-append">
				<button class="btn btn-outline-secondary" type="button" id="pass-gen"><i class="fas fa-random"></i></button>
			</div>
		</div>
